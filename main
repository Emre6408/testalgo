...
//@version=5
indicator("SmudgeTheCat", max_lines_count=500, max_boxes_count=500, max_labels_count=500, max_bars_back=3000, overlay=true)
//-----------------------------------------------------------------------------}
//Strings
//-----------------------------------------------------------------------------{
o          = 'Options'
...
alertcondition(imbalanceUP or imbalanceDN, title="FVG Alert", message="FVG oluştu: {{ticker}} {{interval}}")
